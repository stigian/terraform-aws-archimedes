...
module "container_definition" {
  ...
  port_mappings            = try(each.value.portMappings, var.container_definition_defaults.port_mappings, [])
  ...
  readonly_root_filesystem = try(each.value.readonlyRootFilesystem, var.container_definition_defaults.readonly_root_filesystem, true)
