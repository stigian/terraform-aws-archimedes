...
variable "build_compute_type" {
  ...
  description = "Instance type of the build instance. For more info: https://docs.aws.amazon.com/codebuild/latest/userguide/build-env-ref-compute-types.html"
}
...
variable "aws_region" {
  ...
  description = "(Optional) AWS Region, e.g. us-gov-west-1. Used as CodeBuild ENV variable when building Docker images. For more info: http://docs.aws.amazon.com/codebuild/latest/userguide/sample-docker.html"
}
