...
1. Make your changes, update the README.md as needed, ensuring the changes are well documented.
...
1. After peer review and approval by 2 separate maintainers, we will merge the PR.
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported by contacting the project team at lance@stigian.com. All complaints will be reviewed and investigated and will result in a response that is deemed necessary and appropriate to the circumstances. The project team is obligated to maintain confidentiality with regard to the reporter of an incident. Further details of specific enforcement policies may be posted separately.
